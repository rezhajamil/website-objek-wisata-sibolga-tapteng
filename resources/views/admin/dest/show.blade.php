    ...
    <div class="w-full px-5 py-3 bg-white rounded-lg shadow-lg">
        <div class="grid grid-cols-2">
            <div class="">
                ...
                <a href="{{ route('admin.destination.edit',$destination->id) }}" class="inline-block px-4 py-2 mt-4 font-semibold text-white transition bg-blue-600 rounded-md hover:bg-blue-800">Edit</a>
            </div>
