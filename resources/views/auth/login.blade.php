        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="block mt-4">
                <label for="remember_me" class="inline-flex items-center">
                    <input id="remember_me" type="checkbox" class="border-gray-300 rounded shadow-sm text-sky-600 focus:border-sky-300 focus:ring focus:ring-sky-200 focus:ring-opacity-50" name="remember">
